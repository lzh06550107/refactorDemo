...
$audit = (string) file_get_contents($root . '/modules/openplatform/application/OpenPlatformAudit.php');
$completionService = (string) file_get_contents($root . '/modules/openplatform/application/AuthorizationCompletionService.php');
$transactionManager = (string) file_get_contents($root . '/app/common/infrastructure/ThinkPhpTransactionManager.php');
$provisioning = (string) file_get_contents($root . '/modules/openplatform/infrastructure/AuditedAuthorizerProvisioningRepository.php');
$metadata = (string) file_get_contents($root . '/modules/openplatform/infrastructure/AuditedAuthorizerMetadataRepository.php');
$connection = (string) file_get_contents($root . '/modules/openplatform/infrastructure/AuditedAuthorizerConnectionStore.php');
$finalizer = (string) file_get_contents($root . '/modules/openplatform/infrastructure/AuditedAuthorizerAccountFinalizer.php');
