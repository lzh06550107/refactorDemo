# ST-11-02 — Legacy Route/Module Adapter

所属：EPIC-11 Migration & Compatibility

## User Story
作为平台/租户相关角色，我希望系统提供“Legacy Route/Module Adapter”，以在保持 WeEngine 核心业务结果兼容的同时获得更清晰、可测试的实现。
