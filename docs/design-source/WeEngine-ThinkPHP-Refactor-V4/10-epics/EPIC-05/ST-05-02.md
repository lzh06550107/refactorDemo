# ST-05-02 — Account Creation Quota

所属：EPIC-05 Entitlement & Quota

## User Story
作为平台/租户相关角色，我希望系统提供“Account Creation Quota”，以在保持 WeEngine 核心业务结果兼容的同时获得更清晰、可测试的实现。
...
### 关键业务规则
兼容旧 `permission_user_account_num()` 结果：基础组 + extra_limit + create_group + purchased - consumed，并支持副创始人/Reseller 父级额度封顶。按 AccountType 独立计算。
