# ST-03-02 — Account/AccountType/Capability

所属：EPIC-03 Tenant & Account

## User Story
作为平台/租户相关角色，我希望系统提供“Account/AccountType/Capability”，以在保持 WeEngine 核心业务结果兼容的同时获得更清晰、可测试的实现。
