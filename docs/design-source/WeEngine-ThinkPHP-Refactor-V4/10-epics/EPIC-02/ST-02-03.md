# ST-02-03 — 菜单投影与服务端 ACL

所属：EPIC-02 IAM

## User Story
作为平台/租户相关角色，我希望系统提供“菜单投影与服务端 ACL”，以在保持 WeEngine 核心业务结果兼容的同时获得更清晰、可测试的实现。
...
### 关键业务规则
“菜单显示”只能是 `EffectivePermission` 的投影；URL/API 服务端必须独立强制校验，禁止把隐藏菜单当安全控制。
